...
void Filter2DKernel(
  ...
  {
    #pragma HLS INTERFACE m_axi     port=src    offset=slave bundle=port0    max_read_burst_length=256  
    ...
    #pragma HLS INTERFACE m_axi     port=coeffs offset=slave bundle=port1    max_read_burst_length=256
